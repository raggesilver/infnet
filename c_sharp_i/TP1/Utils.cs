...
public static class Utils
{
  ...
  /// </returns>
  public static string ReadNonEmptyString(string message, string error = "Campo não pode ser vazio",
  ...
  /// </returns>
  public static float ReadFloat(string message, string error = "Número inválido",
