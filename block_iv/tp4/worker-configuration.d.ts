...
declare class DOMException extends Error {
  ...
  /**
   * The **`name`** read-only property of the one of the strings associated
   * with an error name.
   *
   * [MDN
   ...
   * one of the legacy error code constants, or `0` if none match.
   *
   * @deprecated
   *
   *   [MDN
...
interface Console {
  ...
  clear(): void;
  /**
   * The **`console.count()`** static method logs the number of times that
  ...
  /**
   * The **`console.debug()`** static method outputs a message to the console
  ...
  /**
   * The **`console.error()`** static method outputs a message to the console
   ...
   * Web console log, causing any subsequent console messages to be indented
   * by an additional level, until console/groupEnd_static is called.
   *
   * [MDN
  ...
  group(...data: any[]): void;
  /**
   * The **`console.groupCollapsed()`** static method creates a new inline
  ...
  /**
   * The **`console.time()`** static method starts a timer you can use to
  ...
  /**
   * The **`console.timeEnd()`** static method stops a timer that was
  ...
  /**
   * The **`console.timeLog()`** static method logs the current value of a
   * timer that was previously started by calling console/time_static.
   *
   * [MDN
...
declare class Event {
   ...
   * whether the event can be canceled, and therefore prevented as if the
  ...
  /**
   * The **`isTrusted`** read-only property of the when the event was
   * generated by the user agent (including via user actions and programmatic
   * methods such as HTMLElement.focus()), and `false` when the event was
   * dispatched via The only exception is the `click` event, which initializes
  ...
  /**
   * The **`stopImmediatePropagation()`** method of the If several listeners
   * are attached to the same element for the same event type, they are called
   ...
   * further propagation of the current event in the capturing and bubbling
   * phases.
   *
   * [MDN
  ...
  /**
   * The **`composedPath()`** method of the Event interface returns the
   * event's path which is an array of the objects on which listeners will be
   * invoked.
   *
   * [MDN
...
declare class Blob {
  ...
  /**
   * The **`size`** read-only property of the Blob interface returns the size
   * of the Blob or File in bytes.
   *
  ...
  /**
   * The **`arrayBuffer()`** method of the Blob interface returns a Promise
   * that resolves with the contents of the blob as binary data contained in
   * an ArrayBuffer.
   *
   * [MDN
  ...
  /**
   * The **`text()`** method of the string containing the contents of the
   * blob, interpreted as UTF-8.
   *
...
declare class File extends Blob {
   ...
   * of the file represented by a File object.
   *
   ...
   * the last modified date of the file as the number of milliseconds since
   * the Unix epoch (January 1, 1970 at midnight).
   *
   * [MDN
...
declare abstract class Crypto {
  ...
  >(buffer: T): T;
  /**
   * The **`randomUUID()`** method of the Crypto interface is used to generate
   * a v4 UUID using a cryptographically secure random number generator.
...
declare abstract class SubtleCrypto {
  ...
  /**
   * The **`verify()`** method of the SubtleCrypto interface verifies a
   * digital signature.
   *
   * [MDN
   ...
   * that is, it takes as input a key in an external, portable format and
...
declare abstract class CryptoKey {
   ...
   * an object describing the algorithm for which this key can be used, and
   * any associated extra parameters.
   *
   * [MDN
...
declare class TextEncoder {
  constructor();
  /**
   * The **`TextEncoder.encode()`** method takes a string as input, and
   * returns a Global_Objects/Uint8Array containing the text given in
   * parameters encoded with the specific method for that TextEncoder object.
   *
   * [MDN
...
declare class ErrorEvent extends Event {
  ...
  /**
   * The **`filename`** read-only property of the ErrorEvent interface returns
   * a string containing the name of the script file in which the error
   * occurred.
   *
   * [MDN
   ...
   * integer containing the column number of the script file on which the
   * error occurred.
   *
   * [MDN
...
declare class MessageEvent extends Event {
  ...
  /**
   * The **`source`** read-only property of the a WindowProxy, MessagePort, or
   * a `MessageEventSource` (which can be a WindowProxy, message emitter.
   *
   * [MDN
...
declare abstract class PromiseRejectionEvent extends Event {
  ...
  /**
   * The PromiseRejectionEvent **`reason`** read-only property is any
   * JavaScript value or Object which provides the reason passed into
   * Promise.reject().
   *
   * [MDN
...
declare class Headers {
   ...
   * onto an existing header inside a `Headers` object, or adds the header if
...
> extends Body {
  ...
  method: string;
  /**
   * The **`url`** read-only property of the Request interface contains the
   * URL of the request.
   *
...
interface ReadableStream<R = any> {
   ...
   * current `ReadableStream` to a given WritableStream and returns a Promise
   * that fulfills when the piping process completes successfully, or rejects
   * if any errors were encountered.
   *
   * [MDN
...
declare abstract class TransformStreamDefaultController<O = any> {
   ...
   * interface errors both sides of the stream.
   *
   * [MDN
...
declare class URL {
  ...
  /**
   * The **`pathname`** property of the URL interface represents a location in
  ...
  /**
   * The **`toJSON()`** method of the URL interface returns a string
   * containing a serialized version of the URL, although in practice it seems
   * to have the same effect as `js-nolint toJSON() ` None.
   *
  ...
  /**
   * The **`revokeObjectURL()`** static method of the URL interface releases
   * an existing object URL which was previously created by calling Call this
   * method when you've finished using an object URL to let the browser know
   * not to keep the reference to the file any longer.
   *
   * [MDN
...
declare class URLSearchParams {
   ...
   * contained in this object in place and returns `undefined`.
   *
   * [MDN
...
declare class CloseEvent extends Event {
   ...
   * the WebSocket connection close reason the server gave for closing the
...
interface WebSocket extends EventTarget<WebSocketEventMap> {
  ...
  /**
   * The **`WebSocket.close()`** method closes the already `CLOSED`, this
   * method does nothing.
   *
   * [MDN
  ...
  readyState: number;
  /**
   * The **`WebSocket.url`** read-only property returns the absolute URL of
   * the WebSocket as resolved by the constructor.
   *
   ...
   * specified in the `protocols` parameter when creating the WebSocket
...
declare abstract class MessagePort extends EventTarget {
  ...
  /**
   * The **`close()`** method of the MessagePort interface disconnects the
   * port, so it is no longer active.
   *
   * [MDN
  ...
  close(): void;
  /**
   * The **`start()`** method of the MessagePort interface starts the sending
   * of messages queued on the port.
   *
   * [MDN
...
declare class MessageChannel {
  constructor();
  /**
   * The **`port1`** read-only property of the the port attached to the
  ...
  /**
   * The **`port2`** read-only property of the the port attached to the
   * context at the other end of the channel, which the message is initially
   * sent to.
   *
   * [MDN
...
type Ai_Cf_Baai_Bge_Base_En_V1_5_Input =
  | {
       ...
       * generate more accurate embeddings on larger inputs - however, embeddings
       * created with cls pooling are not compatible with embeddings generated
       * with mean pooling. The default pooling method is `mean` in order for this
       * to not be a breaking change, but we highly suggest using the new `cls`
       * pooling for better accuracy.
       */
      pooling?: "mean" | "cls";
    }
  | {
...
interface Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Async_Batch {
  requests?: {
    /**
     * User-supplied reference. This field will be present in the response
     * as well it can be used to reference the request and response. It's
     * NOT validated to be unique.
     */
...
interface Ai_Cf_Meta_Llama_4_Scout_17B_16E_Instruct_Messages {
  ...
  messages: {
    ...
    role?: string;
    /**
     * The tool call id. If you don't know what to put here you can fall
     * back to 000000001
     */
    tool_call_id?: string;
    content?:
...
interface Ai_Cf_Deepgram_Nova_3_Input {
  ...
  /**
   * Custom topics you want the model to detect within your input audio or
   * text if present Submit up to 100
   */
  custom_topic?: string;
  /**
   * Sets how the model will interpret intents submitted to the custom_intent
   * param. When strict, the model will only return intents submitted using
   * the custom_intent param. When extended, the model will return its own
   * detected intents in addition those submitted using the custom_intents
   * param
   */
  ...
  mip_opt_out?: boolean;
  /**
   * Mode of operation for the model representing broad area of topic that
   * will be talked about in the supplied audio
   */
   ...
   * evolve over time. Note: Supported only for webosockets.
   */
  interim_results?: boolean;
  /**
   * Indicates how long model will wait to detect whether a speaker has
   * finished speaking or pauses for a significant period of time. When set to
   * a value, the streaming endpoint immediately finalizes the transcription
   * for the processed time range and returns the transcript with a
   * speech_final parameter set to true. Can also be set to false to disable
   * endpointing
   */
  endpointing?: string;
  /**
  ...
  vad_events?: boolean;
  /**
   * Indicates how long model will wait to send an UtteranceEnd message after
   * a word has been transcribed. Use with interim_results. Note: Supported
   * only for webosockets.
   */
...
interface Ai_Cf_Pfnet_Plamo_Embedding_1B_Output {
  ...
  data: number[][];
  /**
   * Shape of the embedding data as [number_of_embeddings,
   * embedding_dimension].
   *
   * @minItems 2
   * @maxItems 2
...
interface Ai_Cf_Deepgram_Flux_Output {
  ...
  request_id?: string;
  /**
   * Starts at 0 and increments for each message the server sends to the
   * client.
   */
  sequence_id?: number;
...
type AiOptions = {
  /**
   * Send requests as an asynchronous batch job, only works for supported
   * models https://developers.cloudflare.com/workers-ai/features/batch-api
   */
   ...
   * @ Each tag can have maximum 50 characters. Maximum 5 tags are allowed
   * each request. Duplicate tags will removed.
   */
  tags?: string[];
