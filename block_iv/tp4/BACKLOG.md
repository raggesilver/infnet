...
- [x] **Navegação com React Router** — Rotas para listagem e criação de eventos (TP3)
- [x] **Testes automatizados** — Testes de componente com Vitest + RTL e testes E2E com Cypress (TP4)
- [x] **Responsividade desktop** — Grid de cards em 2 colunas e max-width maior em telas >= 768px (TP4)
