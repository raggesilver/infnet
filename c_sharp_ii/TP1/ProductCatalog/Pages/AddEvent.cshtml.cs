...
public class AddEventModel : PageModel
{
    ...
    private void SaveEvent(Event evt)
    {
        ...
        HttpContext.Session.SetString("Events", System.Text.Json.JsonSerializer.Serialize(events));
    }
    ...
    private List<Event> GetStoredEvents()
    {
        ...
        try
        {
            return System.Text.Json.JsonSerializer.Deserialize<List<Event>>(eventsJson) ?? new List<Event>();
        }
        catch
        {
            return new List<Event>();
